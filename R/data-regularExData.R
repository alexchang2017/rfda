...
#' each subject are equally spaced values on [0,10]. The number of true principal
...
#'
#' @format A data.frame with 6000 observations on 3 variables.
#' \itemize{
