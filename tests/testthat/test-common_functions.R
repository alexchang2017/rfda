...
test_that("factorial_f", {
  expect_equal(rpace:::factorial_f(0L), factorial(0))
  expect_equal(rpace:::factorial_f(1L), factorial(1))
  expect_equal(rpace:::factorial_f(2L), factorial(2))
  expect_equal(rpace:::factorial_f(3L), factorial(3))
  expect_equal(rpace:::factorial_f(5L), factorial(5))
  expect_true(is.nan(rpace:::factorial_f(-1)))
  expect_error(rpace:::factorial_f(0.5))
  expect_error(rpace:::factorial_f(2.5))
})
